...
def main() -> int:
    ...
    print(
        "AegisSec Step 10 Fairness "
        "and Robustness Evaluation"
    )

    print(
        "Exact policy cases:",
        f"{exact['exact_case_count']}/"
        f"{exact['case_count']}",
    )

    print(
        "Under-triage cases:",
        safety["under_triage_count"],
    )

    print(
        "Safety recall:",
        f"{safety['safety_recall']:.4f}",
    )
    ...
    print(
        ...
        f"{rules['covered_required_rule_count']}/"
        f"{rules['required_rule_count']}",
    )

    print(
        "Full policy-rule coverage:",
        f"{rules['covered_policy_rule_count']}/"
        f"{rules['policy_rule_count']}",
    )

    print(
        "Stage gate:",
        release["stage_gate_status"],
    )
